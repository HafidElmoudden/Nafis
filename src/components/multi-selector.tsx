...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    <div
      ...
      className={cn(
        "flex flex-wrap gap-1 p-1 py-2 border border-muted rounded-lg bg-background | focus-within:outline focus-within:outline-primary focus-within:border-transparent bg-white font-medium box-border border-accent-100 outline-none shadow-sm",
        className
      )}
      {...props}
    >
      {value.map((item, index) => (
        <Badge
          key={item}
          className={cn(
            "px-1 rounded-xl flex items-center gap-1 bg-white text-black",
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <CommandPrimitive.Input
      ...
      className={cn(
        "ml-2 bg-transparent outline-none flex-1",
        className,
