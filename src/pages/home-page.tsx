...
function Home() {
  return (
    <div className='relative w-full h-full flex justify-center items-center'>
      ...
      <svg className='absolute overflow-hidden top-25 right-10 z-10 w-64 h-64 blur-3xl' viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className='flex flex-col space-y-6 pt-10 sm:w-[350px] '>
